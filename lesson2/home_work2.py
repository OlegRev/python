...
my_list = [1,2,3,4,4,5,6,7,8,9,0,7,'a','s','d','f','g','h','j','k']
print(my_list )
lst_a = list(set(my_list)) #получение
print(lst_a)         #a - списка
lst_b = []
for i in my_list:
    if my_list.count(i) == 1:# получение
        lst_b.append(i)      #б-списка
print(lst_b)
...
print('Решение уравнения следующего вида : y = k*x + b')
x = float(input('введите x :')) #x = 2.5
k = float(input('введите k :')) #k = -12
b = float(input('введите b :')) #b = 11111140.2121
y = k * x + b
print('y = ', y)
...
data = input('Введите дату в формате 01.01.2001:')#'03.04.2015'
data_split = data.split('.')
conv_day = int(data_split[0])
conv_month = int(data_split[1])
conv_year = int(data_split[2])
month_31 = [1, 3, 5, 7, 8, 10, 12]
if len(data_split[0])!=2 or len(data_split[1])!=2 or len(data_split[2])!=4:
    print('формат даты введен не коректно!')
elif conv_day>31 or conv_day<1:
    print('формат дня введен не коректно!')
elif conv_month>12 or conv_month<1:
    print('формат месяца введен не коректно!')
elif conv_month not in month_31 and conv_day > 30:
    print('формат дня введен не коректно!')
elif conv_year>9999 or conv_year<1:
    print('формат года введен не коректно!')
else:
    print('{} {} {} года'.format(day[data_split[0]], month[data_split[1]], data_split[2]))
